...
const CDB_ENDPOINT = '//directbidder-test-app.par.preprod.crto.in/cdb';
...
export const spec = {
  ...
  buildRequests: (bidRequests, bidderRequest) => {
    let loadFastBidPromise = new Promise((resolve, _) => resolve(false));
    let callCdbPromise = new Promise((resolve, _) => resolve({}));
    ...
    if (!publisherTagAvailable()) {
      ...
      setTimeout(() => {
        loadExternalScript("http://127.0.0.1:8082/publishertag.prebid.js", BIDDER_CODE);
